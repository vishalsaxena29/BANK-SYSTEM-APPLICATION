...
class Bank:
    ...
    def __init__(self,master):
        ...
        self.master.configure(background='#4f845b')
    ...
    def menu(self):
        ...
        self.menu = tk.Frame(self.master,bg="#4f845b")

        self.m_l1 = Label(self.menu,text='Welcome {}'.format(self.user),bg="#4f845b",font=('Times','40','bold'),fg="#ffffff")
    ...
    def main_frame(self):
        ...
        self.f = Frame(self.master,bg='#4f845b')
        Bank.username = StringVar()
        Bank.password = StringVar()

        self.l0 = Label(self.f,text="Welcome To Banking Services",bg='#4f845b',font=('Times','20','bold'),fg='#abcdef')
        self.l0.grid(row=0,column=0,columnspan=3)

        self.l1 = Label(self.f,text='UserName : ',bg='#4f845b',font=('Times','30','bold'),fg='#123456')
        ...
        self.l2 = Label(self.f,text='Password : ',bg='#4f845b',font=('Times','30','bold'),fg='#123456')
    ...
    def signup(self):
            ...
            self.f.grid_forget()
            self.sp = Frame(self.master,bg='#4f845b')

            self.sl1 = Label(self.sp,text='UserName : ',bg='#4f845b',font=('Times','30','bold'),fg='#123456')
            ...
            self.sl2 = Label(self.sp,text='Password : ',bg='#4f845b',font=('Times','30','bold'),fg='#123456')
            ...
            self.sl3 = Label(self.sp,text='Balance : ',bg='#4f845b',font=('Times','30','bold'),fg='#123456')
